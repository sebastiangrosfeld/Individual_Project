...
import com.github.sebastiangrosfeld.individual_proj_back.config.JwtService;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        Optional<User> userFromDB = repository.findByEmail(validationUser.getEmail());

        if(userFromDB.isPresent()) {
            throw new UserAlreadyExistException("User with email " + validationUser.getEmail() + " already exists");
        }
